...
class data_parcing:
    ...
    def test_data_convert_format(self):
        ...
        for i in range(len(IOT_data)):
            ...
            temparature.append([temp_data['TIME'], temp_data['TEMP'], label[0]])
            humidity.append([temp_data['TIME'], temp_data['HUM'], label[1]])
            gas.append([temp_data['TIME'], temp_data['LPG'], label[2]])
